...
public class ItemsProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        final dex.xyzreader.data.SelectionBuilder builder = buildSelection(uri);
    ...
    private dex.xyzreader.data.SelectionBuilder buildSelection(Uri uri) {
        final dex.xyzreader.data.SelectionBuilder builder = new dex.xyzreader.data.SelectionBuilder();
        final int match = sUriMatcher.match(uri);
        return buildSelection(uri, match, builder);
    }

    private dex.xyzreader.data.SelectionBuilder buildSelection(Uri uri, int match, dex.xyzreader.data.SelectionBuilder builder) {
